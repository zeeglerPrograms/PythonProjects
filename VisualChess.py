...
class Board:
    ...
    def draw_board(self, player, screen): 
        rows = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h']
        ...
        for i in range(8):
            ...
            if color == 'white':
                ...
                color = 'white'
            y += size
            # draw ranks on right side
        #print rows on the bottom
    ...
    def draw_square(self, row, rank, rows, ranks):
        ...
        if self.pos in squares_taken:
            # draw a piece here with self.pos
            pass
        else:
            #dont draw a piece here
            pass
...
class Game():
    ...
    def game_loop(self):
        #testing adding in the visual elements
        ...
        while check_mate == False and running == True:
            ...
            board.draw_board(player_turn_ref, self.screen)
